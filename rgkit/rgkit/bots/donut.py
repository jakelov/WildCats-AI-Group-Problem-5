# Based on Dulladob 0.1 by Camelot Chess
...
staying_still_bonus = 0.39  # points for staying put
...
spawn_weight = 0.28  # points lost being spawn; multiplied by turns since death
...
def strong_hunt_the_weak(this_robot, game, illegals):
    ...
    if this_robot.hp < 26:  #RED TEAM: changed value from 30 to 26
        return 'no_action'
    weakest_enemy = 20
    best_move = 'no_action'
    for bot in one_robots:
